                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark">
                            <li><a class="dropdown-item active"
                                    href="/board/board_detail/file_download?file_path=<?= urlencode($file_info->file_path) ?>">
                                    <?= $file_info->file_name ?>
                                </a></li>
                        </ul>
                    </div>
            ...
            <div class="detail_comments_member">
                ...
                <? if (isset($user_id)) { ?>
                    ...
                    <form id="detail_comments_write" action="#" method="post">
                        <input type="hidden" id="comment_user_id" value="<?= $user_id ?>">
                        <input type="hidden" id="comment_article_num" value="<?= $board->article_num ?>">
                        <input type="hidden" id="comment_post_parent_id" value="<?= $board->parent_id ?>">
                        ...
                        <div>
                            <input id="detail_comments_write_text" type="text" name="detail_comments_write_text"
                                placeholder="댓글을 남겨보세요.">
                            <button type="submit" class="btn btn-secondary"
                                id="detail_comments_write_text_submit">등록</button>
                        </div>
                    </form>
                <? } ?>
            </div>
